...
## Exploring Poniverse.net
This project has been generated from the opinionated [HotTowel](https://github.com/johnpapa/generator-hottowel) yo generator.

### Structure
The structure also contains a gulpfile.js and a server folder. The server is there so we can serve the app using node and proxy requests to the api through it.
...
### Installing Packages
When you install the project you should run these commands, but if you notice missing packages, run these again:
